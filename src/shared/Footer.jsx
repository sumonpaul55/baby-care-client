                ...
                <div className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        <div className="col-span-full lg:col-span-1">
                            <img src={logo} alt="" className='w-52 -mt-3' />
                            <p className='mt-4 text-white text-base'>
                                Welcome to our baby care haven, where every little ones well-being is our top priority. Discover expert tips and trusted products to nurture your babys health and happiness.
                            </p>
                        </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="mt-3 grid space-y-3">
                                ...
                                <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Careers</a> <span className="inline ms-1 text-xs bg-blue-700 text-white py-1 px-2 rounded-lg">We are hiring</span></p>
